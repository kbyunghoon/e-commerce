...
data class BalanceChargeResponse(
    ...
    companion object {
        fun from(balanceHistory: BalanceHistory): BalanceChargeResponse {
            return BalanceChargeResponse(
                userId = balanceHistory.userId,
                balance = balanceHistory.afterAmount,
                chargedAmount = balanceHistory.amount,
                chargedAt = balanceHistory.transactionAt
            )
        }
    }
}
